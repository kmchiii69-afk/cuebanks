...
export default function PrivacyPage() {
  return (
    <LegalShell kicker="Legal" title="Privacy Policy" effectiveDate="May 18, 2026">
      <P>
        This Privacy Policy explains how <strong className="text-bone">Wall Street Academy</strong> (&ldquo;Company,&rdquo; &ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;), collects, uses, shares, and protects personal information you provide through cuebanks.vercel.app and any related domains, applications, or services (collectively, the &ldquo;Services&rdquo;).
      </P>
      <P>
      ...
      <UL>
        <LI><strong className="text-bone">CRM:</strong> Close (close.com) — lead and sales pipeline management</LI>
        <LI><strong className="text-bone">Email automation:</strong> Kit (kit.com) — email sequences and newsletters</LI>
        <LI><strong className="text-bone">Scheduling:</strong> Calendly — call booking</LI>
        <LI><strong className="text-bone">Form software:</strong> Tally — application and qualification forms</LI>
        <LI><strong className="text-bone">Analytics:</strong> PostHog and similar tools — funnel analytics and session replay</LI>
        <LI><strong className="text-bone">Hosting:</strong> Vercel — site and application hosting</LI>
        <LI><strong className="text-bone">Payment processors:</strong> Stripe and similar — payment processing</LI>
        <LI><strong className="text-bone">Internal team communication:</strong> Discord — operational notifications to our sales team</LI>
      </UL>
      <P>
      ...
      <P>
        To exercise these rights, submit a request through our contact form at <a href="https://cuebanks.vercel.app/contact" className="text-acid">cuebanks.vercel.app/contact</a>.
      </P>
      ...
      <P>
        ...
        Submit a request through our contact form at <a href="https://cuebanks.vercel.app/contact" className="text-acid">cuebanks.vercel.app/contact</a>.
      </P>
