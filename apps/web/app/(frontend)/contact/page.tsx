...
import { WsaButton, Eyebrow, TopBar, WsaShell, WsaWrap } from "@/components/wsa/ui";
  ...
  return (
    <WsaShell>
      ...
      <section className="grid-bg" style={{ position: "relative", overflow: "hidden", borderBottom: `1px solid ${wsa.line}` }}>
        ...
        <WsaWrap style={{ position: "relative", padding: "84px 22px 56px", textAlign: "center" }}>
      ...
      {/* BODY */}
      <WsaWrap style={{ padding: "72px 22px 96px" }}>
        <div className="ct-grid" style={{ display: "grid", gridTemplateColumns: "0.85fr 1.15fr", gap: 56, alignItems: "start" }}>
          ...
          <div>
            ...
            <div style={{ borderTop: `1px solid ${wsa.line}`, paddingTop: 22 }}>
              ...
              <WsaButton href="/qualify">Apply For Your Seat →</WsaButton>
            </div>
          </div>
      ...
      <footer style={{ borderTop: `1px solid ${wsa.line}`, padding: "30px 0" }}>
        <WsaWrap style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 20, flexWrap: "wrap" }}>
