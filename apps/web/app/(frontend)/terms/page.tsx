...
export default function TermsPage() {
  return (
    <LegalShell kicker="Legal" title="Terms of Service" effectiveDate="May 18, 2026">
      <P>
        These Terms of Service (&ldquo;Terms&rdquo;) form a binding agreement between you and <strong className="text-bone">Wall Street Academy</strong> (&ldquo;Company,&rdquo; &ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;), operating under the brand <strong className="text-bone">Wall Street Academy</strong>. They govern your access to and use of our website, applications, courses, communities, coaching, mentorship, and any other products or services we offer (collectively, the &ldquo;Services&rdquo;).
      </P>
      <P>
      ...
      <Callout>
        Everything we publish, teach, broadcast, or distribute is <strong className="text-bone">educational content and personal opinion</strong>. We are not a registered investment adviser, broker-dealer, financial planner, or fiduciary, and nothing in the Services constitutes investment, financial, tax, legal, or accounting advice.
      </Callout>
      <P>
        You alone are responsible for your trading decisions. You should consult a licensed professional before making any financial decision. See our full <a href="/disclaimer" className="text-acid">Disclaimer</a> for the complete risk disclosure.
      </P>
      ...
      <UL>
        ...
        <LI>Refunds are governed by our <a href="/refund" className="text-acid">Refund Policy</a>.</LI>
