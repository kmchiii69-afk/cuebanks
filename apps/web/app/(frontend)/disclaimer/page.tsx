...
export default function DisclaimerPage() {
  return (
    <LegalShell kicker="Legal" title="Disclaimer" effectiveDate="May 18, 2026">
      <Callout>
        Trading the financial markets — including but not limited to cryptocurrencies, stocks, forex, futures, options, and CFDs — involves <strong className="text-bone">substantial risk of loss</strong> and is not suitable for every investor. You can lose all of the capital you commit, and in some products, more than your initial deposit. Past performance is not indicative of future results.
      </Callout>

      <H2>1. Educational Content Only</H2>
      <P>
        All content published by <strong className="text-bone">Wall Street Academy</strong>, operating under the brand <strong className="text-bone">Wall Street Academy</strong> — including but not limited to websites, courses, videos, livestreams, podcasts, written materials, software, indicators, scripts, frameworks, social media posts, and one-on-one coaching — is provided strictly for <strong className="text-bone">educational and informational purposes</strong>.
      </P>
      <P>
      ...
      <P>
        We are <strong className="text-bone">not</strong>:
      </P>
      <UL>
      ...
      <UL>
        <LI><strong className="text-bone">Most retail traders lose money.</strong> The majority of people who attempt to trade actively lose some or all of their capital.</LI>
        <LI><strong className="text-bone">You can lose more than your initial deposit</strong> in leveraged products such as futures, options, perpetuals, and margin accounts.</LI>
        <LI><strong className="text-bone">Cryptocurrencies are highly volatile</strong> and largely unregulated. Many tokens go to zero.</LI>
        <LI><strong className="text-bone">No system, strategy, or methodology — including ours — guarantees profit.</strong> Markets change, edges erode, and execution is your responsibility.</LI>
        <LI>Only trade with capital you can afford to lose completely.</LI>
      </UL>

      <H2>4. Hypothetical and Past Performance</H2>
      <P>
        Any references to charts, trade examples, backtests, hypothetical results, or historical performance are presented for educational illustration only. <strong className="text-bone">Past performance is not a reliable indicator of future results.</strong> Hypothetical or simulated results have inherent limitations and may not reflect the impact of real market conditions, slippage, liquidity, fees, or psychology.
      </P>

      <H2>5. Testimonial Disclaimer</H2>
      <P>
        Student testimonials, case studies, screenshots of P&amp;L, video reviews, and other social proof shown on our website or in our marketing represent <strong className="text-bone">individual experiences</strong>. These results are not typical, not guaranteed, and depend on a wide range of factors including but not limited to capital, risk management, market conditions, time commitment, discipline, and prior experience.
      </P>
      <P>
      ...
      <P>
        Any references to income, profit, or financial success that you may earn or generate from trading, our programs, or applying our methodology are illustrative only. We make <strong className="text-bone">no representation, warranty, or guarantee</strong> that you will achieve any specific income or result. The success of any individual depends on numerous factors outside our control.
      </P>
      ...
      <P>
        ...
        <strong className="text-bone">Wall Street Academy</strong><br />
        Submit a request through our contact form at{" "}
        <a href="https://cuebanks.vercel.app/contact" className="text-acid">
          cuebanks.vercel.app/contact
        </a>
        .
      </P>
