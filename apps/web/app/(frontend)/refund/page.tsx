...
export default function RefundPage() {
  return (
    <LegalShell kicker="Legal" title="Refund Policy" effectiveDate="May 18, 2026">
      <P>
        This Refund Policy explains when and how you may request a refund for products and services purchased from <strong className="text-bone">Wall Street Academy</strong>, operating under the brand <strong className="text-bone">Wall Street Academy</strong>. By purchasing any product or service from us, you agree to this policy.
      </P>
      ...
      <P>
        Because our products consist primarily of digital educational content, live sessions, community access, and proprietary methodology — all of which are delivered instantly and cannot be &ldquo;returned&rdquo; — <strong className="text-bone">all sales are final unless otherwise stated in this policy or in the specific product&rsquo;s purchase terms</strong>.
      </P>

      <H2>2. Limited 7-Day Refund Window</H2>
      <P>
        For certain flagship paid programs, we offer a <strong className="text-bone">7-day refund window</strong> from the date of purchase, subject to <strong className="text-bone">all</strong> of the following conditions:
      </P>
      <UL>
        <LI>The refund request is submitted through our contact form at <a href="https://cuebanks.vercel.app/contact" className="text-acid">cuebanks.vercel.app/contact</a> within seven (7) calendar days of the original purchase date.</LI>
        ...
        <LI>You have not violated the <a href="/terms" className="text-acid">Terms of Service</a>.</LI>
      </UL>
      <P>
      ...
      <P>The following are <strong className="text-bone">not eligible for a refund under any circumstance</strong>:</P>
      <UL>
      ...
      <P>
        If you have a billing concern, <strong className="text-bone">contact us first</strong> before filing a chargeback with your bank or card issuer. Filing a chargeback without first attempting to resolve the matter with us is a violation of these terms and may result in:
      </P>
      <UL>
      ...
      <P>To request a refund, submit a ticket through our contact form at <a href="https://cuebanks.vercel.app/contact" className="text-acid">cuebanks.vercel.app/contact</a> with:</P>
      <UL>
      ...
      <P>
        ...
        Submit a ticket through our contact form at <a href="https://cuebanks.vercel.app/contact" className="text-acid">cuebanks.vercel.app/contact</a>.
      </P>
