  ...
  return (
    <div className="mb-15">
      <div className="flex items-center gap-4 mb-6 flex-wrap">
        <span className="font-mono text-[11px] font-semibold text-acid tracking-[0.22em] px-3 py-1.5 border border-acid">§ {num}</span>
        <span className="font-mono text-[11px] font-semibold text-acid tracking-[0.24em] uppercase">{label}</span>
      </div>
      <h2 className="font-display font-semibold text-[76px] leading-[0.98] tracking-[-0.04em] text-bone m-0 mb-6 max-w-[1100px]">{title}</h2>
      {sub && <p className="font-body text-[19px] leading-[1.6] text-ash m-0 max-w-[820px] font-normal">{sub}</p>}
    </div>
  );
}
